        ...
        return (
            <article role="article" className="blog-article"  id={props.data.id}>
                ...
                <footer className="blog-article__info" role="contentinfoo">
                    <time role="alert" className="blog-article__date"><span><svg  role="img" className="blog-article__date-icon"><use xlinkHref='images/sprite.svg#icon-clock'/></svg></span>{props.data.time}</time>
